...
const Login: React.FC<{
  onSubmit: (formvalues: logindataTypes, form: any) => void;
  initalValues: logindataTypes;
}> = (props) => {
  const { onSubmit, initalValues } = props;
          ...
          <div className="row">
            <div className="col-md-12">
              <Link className="logo" to="/">
                <img width="165" className="img-fluid " src={logo} alt="logo" />
              </Link>
            </div>
          </div>
