...
!(function(e, t) {
  ...
  let c = { type: !0, src: !0, nonce: !0, noModule: !0 };
  function b(e, t, n) {
    let r;
    var i;
    let o = (n = n || E).createElement('script');
    if (((o.text = e), t))
      for (r in c)
  ...
  const h = (function(n) {
    ...
    var $ =
      ...
      W +
      ')*)|.*)\\)|)';
    let F = new RegExp(`${M  }+`, 'g');
    let B = new RegExp(`^${  M  }+|((?:^|[^\\\\])(?:\\\\.)*)${  M  }+$`, 'g');
    var _ = new RegExp(`^${  M  }*,${  M  }*`);
    let z = new RegExp(`^${  M  }*([>+~]|${  M  })${  M  }*`);
    var U = new RegExp(`${M  }|>`);
    var X = new RegExp($);
    let V = new RegExp(`^${  I  }$`);
    var G = {
    ...
    var Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/;
    var ee = /[+~]/;
    let te = new RegExp(`\\\\([\\da-f]{1,6}${  M  }?|(${  M  })|.)`, 'ig');
    ...
    return (
        ...
        if (!a) {
          ...
          (a = A(
            ...
            (r = function(e, t, n, r, i) {
              ...
              let h = (S += p == null ? 1 : Math.random() || 0.1);
              let g = d.length;
              for (
                i && (w = t === C || t || i);
                l !== g && (o = d[l]) != null;
      ...
      (g = se.select = function(e, t, n, r) {
        ...
        let s;
        var u;
        let l = typeof e == 'function' && e;
        let c = !r && h((e = l.selector || e));
        if (((n = n || []), c.length === 1)) {
          if (
  ...
  let A = k.expr.match.needsContext;
  function N(e, t) {
  ...
  (k.filter = function(e, t, n) {
    ...
    k.fn.extend({
      ...
      is(e) {
      return !!j(this, typeof e == 'string' && A.test(e) ? k(e) : e || [], !1)
        .length;
    },
    });
  let q;
        ...
        arguments.length < e
          ...
          : void 0 === n
            ...
            : this.each(function() {
              ...
              'fx' === t && e[0] !== 'inprogress' && k.dequeue(this, t);
            })
      );
    },
      dequeue(e) {
  ...
  var Qe = /^--/;
  let Je = { position: 'absolute', visibility: 'hidden', display: 'block' };
  let Ke = { letterSpacing: '0', fontWeight: '400' };
  function Ze(e, t, n) {
    const r = ne.exec(t);
  ...
  function dt(o, e, t) {
    ...
    var a;
    let r = 0;
    let i = dt.prefilters.length;
    let s = k.Deferred().always(function() {
      delete u.elem;
    });
    var u = function() {
      if (a) return !1;
  ...
  k.fn.extend({
    ...
    k.extend({
      ...
      attrHooks: {
        type: {
          set: function(e, t) {
            if (!y.radioValue && t === 'radio' && N(e, 'input')) {
              var n = e.value;
  ...
  let jt = /^(?:input|select|textarea|keygen)/i;
  function qt(n, e, r, i) {
    let t;
    if (Array.isArray(e))
      k.each(e, function(e, t) {
  ...
  let Wt = {};
  var $t = '*/'.concat('*');
  let Ft = E.createElement('a');
  function Bt(o) {
    return function(e, t) {
      typeof e !== 'string' && ((t = e), (e = '*'));
      let n;
      var r = 0;
      let i = e.toLowerCase().match(R) || [];
      if (m(t))
        while ((n = i[r++]))
          n[0] === '+'
  ...
  function zt(e, t) {
    let n;
    var r;
    let i = k.ajaxSettings.flatOptions || {};
  ...
  (Ft.href = Et.href),
    k.extend({
      ...
      var o;
        let v = k.ajaxSetup({}, t);
      var y = v.context || v;
        let m = v.context && (y.nodeType || y.jquery) ? k(y) : k.event;
        let x = k.Deferred();
