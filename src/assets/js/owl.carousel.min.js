  ...
  (e.Defaults = {
    ...
    (e.Workers = [
      ...
      },
      {
        filter: ["width", "items", "settings"],
        run: function (a) {
          const b = (this.width() / this.settings.items).toFixed(3) - this.settings.margin;
          var c = null;
    ...
    (e.prototype.setup = function () {
      ...
      c
        ? (a.each(c, function (a) {
          ...
          typeof e.stagePadding === "function" && (e.stagePadding = e.stagePadding()),
          delete e.responsive,
          e.responsiveClass &&
            this.$element.attr(
              "class",
    ...
    (e.prototype.prepare = function (b) {
      ...
      return (
        c.data || (c.data = a(`<${this.settings.itemElement}/>`).addClass(this.options.itemClass).append(b)),
    ...
    (e.prototype.invalidate = function (b) {
      return (
        a.type(b) === "string" && ((this._invalidated[b] = !0), this.is("valid") && this.leave("valid")),
        ...
        (this._handlers = {
          "initialized.owl.carousel change.owl.carousel resized.owl.carousel": a.proxy(function (b) {
            if (
              ...
              ((b.property && b.property.name == "position") || b.type == "initialized")
            ) {
              const c = this._core.settings;
              let e = (c.center && Math.ceil(c.items / 2)) || c.items;
              var f = (c.center && -1 * e) || 0;
              let g = (b.property && b.property.value !== d ? b.property.value : this._core.current()) + f;
  ...
  (function (a, b, c, d) {
    ...
    (e.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
      (e.prototype.fetch = function (a, b) {
        ...
        let d = a.attr("data-vimeo-id") || a.attr("data-youtube-id") || a.attr("data-vzaar-id");
      ...
      (e.prototype.thumbnail = function (b, c) {
        ...
        let e;
        var f;
        const g = c.width && c.height ? `width:${c.width}px;height:${c.height}px;` : "";
        const h = b.find("img");
        let i = "src";
        var j = "";
      ...
      (e.prototype.play = function (b) {
        ...
        this._playing ||
          ...
          f.type === "youtube"
            ...
            : f.type === "vzaar" && c.attr("src", `//view.vzaar.com/${f.id}/player?autoplay=true`),
          ...
          "changed.owl.carousel": a.proxy(function (a) {
            a.namespace && a.property.name === "settings"
              ? this._core.settings.autoplay
                ? this.play()
                : this.stop()
              : a.namespace && a.property.name === "position" && this._paused && (this._time = 0);
          }, this),
          "initialized.owl.carousel": a.proxy(function (a) {
  ...
  (function (a, b, c, d) {
    ...
    (e.Defaults = {
      ...
      (e.prototype.initialize = function () {
        ...
        (this._controls.$relative = (
          ...
          this._controls.$absolute.on(
            ...
            "button",
            a.proxy(function (b) {
              let d = a(b.target).parent().is(this._controls.$absolute)
                ? a(b.target).index()
      ...
      (e.prototype.update = function () {
        ...
        if (
          (g.slideBy !== "page" && (g.slideBy = Math.min(g.slideBy, g.items)), g.dots || g.slideBy == "page")
        )
